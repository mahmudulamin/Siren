          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-primary-100 text-sm">
                    Strategic Incident Response &amp; Emergency Network
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/emergency-help">
                  <Button
                    size="lg"
                    variant=""
                    className="bg-gray-300 text-gray-900 hover:bg-gray-400 border-2 border-white shadow-lg"
                  >
            ...
            <div className="hidden md:block">
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = 'https://via.placeholder.com/600x400?text=Emergency+Response';
                }}
              />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Submit help requests with location, photos, and emergency type. Get immediate
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Trained volunteers receive assignments, accept tasks, and provide real-time updates
                on their progress.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Emergency officials manage resources, monitor situations, and deploy support using
                AI-powered insights.
              </p>
            </div>
          </div>
